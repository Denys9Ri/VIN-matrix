...
SQL = [
    ...
    "ALTER TABLE core_orderpart ADD COLUMN IF NOT EXISTS reserved_quantity integer NOT NULL DEFAULT 0;",
    "UPDATE core_orderpart SET stock_status = 'none' WHERE stock_status IS NULL;",
    "UPDATE core_orderpart SET reserved_quantity = 0 WHERE reserved_quantity IS NULL;",
    ...
    "CREATE INDEX IF NOT EXISTS core_orderpart_reserved_quantity_idx ON core_orderpart (reserved_quantity);",
