...
class ProfileSettingsView(BaseProfileSettingsView):
    ...
    def patch(self, request):
        ...
        mapping = {
            ...
            'company[payment_link]': 'payment_link', 'payment_link': 'payment_link',
            'company[payment_requisites]': 'payment_requisites', 'payment_requisites': 'payment_requisites',
            'company[payment_instruction]': 'payment_instruction', 'payment_instruction': 'payment_instruction',
