...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--interval', type=int, default=int(os.getenv('LANDING_GROWTH_INTERVAL_SECONDS', '21600')), help='Інтервал між циклами у секундах (типово 6 годин).')
        parser.add_argument('--initial-delay', type=int, default=int(os.getenv('LANDING_GROWTH_INITIAL_DELAY_SECONDS', '120')), help='Затримка перед першим циклом.')
