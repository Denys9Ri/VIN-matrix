...
const Clients = ({ embedded = false }) => {
  ...
  return (
    <div className={embedded ? 'w-full max-w-full overflow-x-hidden' : 'w-full max-w-6xl mx-auto px-3 sm:px-4 md:px-8 py-4 md:py-8 min-h-screen bg-slate-50 overflow-x-hidden'}>
      ...
      {selectedGroup && <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/50 backdrop-blur-sm overflow-hidden">
        <div className="bg-white w-[calc(100vw-1rem)] sm:w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col h-[calc(100dvh-1rem)] sm:h-auto sm:max-h-[calc(100dvh-2rem)] min-w-0">
          ...
          <div className="px-3 md:px-6 pt-4 bg-white border-b border-slate-100 overflow-x-auto shrink-0">
          ...
          <div className="flex-1 min-h-0 p-3 md:p-6 overflow-y-auto overscroll-contain space-y-4 min-w-0">
