...
import { Search, CarFront, Phone, CalendarDays, Wallet, History, X, Wrench, Store, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 md:pl-72 h-screen flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-y-auto pb-10 pr-2">
        ...
        {clients.length === 0 && (
          <div className="col-span-full text-center py-20 text-slate-400 font-black uppercase text-xl">
