...
export default function ClientsCRM() {
  ...
  const openEdit = (client) => {
    ...
    setEditClient({ key: client.key, client: client.client || '', phone: client.phone || '', plate: car.plate || '', vin_code: car.vin_code || '', overwrite_car: false });
  };
