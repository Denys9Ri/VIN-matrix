...
import { ArrowDownRight, ArrowUpRight, Check, ChevronRight, CirclePlay, ClipboardCheck, Gauge, Layers3, Menu, PackageCheck, ShieldCheck, Sparkles, Wrench, X } from 'lucide-react';
import './Landing.css';
...
export function Landing() {
  ...
  return <div className="vm-landing">
    ...
    <main>
      <section className="vm-hero"><div className="vm-hero-copy"><p className="vm-kicker">ОПЕРАЦІЙНА СИСТЕМА ДЛЯ АВТОБІЗНЕСУ</p><h1>Менше “де це?”, більше <em>“готово”</em>.</h1><p className="vm-hero-text">VIN-matrix збирає замовлення, склад, клієнтів, оплату та команду в один робочий контур — без Excel, хаосу в чатах і втрат на деталях.</p><div className="vm-hero-actions"><a className="vm-cta vm-cta-primary" href="#request">Отримати демо <ArrowUpRight size={18} /></a><a className="vm-cta vm-cta-quiet" href="/demo"><CirclePlay size={18} /> Подивитись у дії</a></div><div className="vm-hero-proof"><div><b>01</b><span>екран<br />контролю</span></div><div><b>14</b><span>днів<br />на старт</span></div><div><b>∞</b><span>порядку<br />в процесах</span></div></div></div><div className="vm-hero-product"><div className="vm-orbit vm-orbit-a" /><div className="vm-orbit vm-orbit-b" /><DashboardPreview /><div className="vm-stamp"><span>СТВОРЕНО ДЛЯ</span><b>СТО · СКЛАД · CRM</b></div></div></section>
