...
export default function LandingLeads() {
  ...
  return <div className="min-h-full bg-slate-50 p-4 sm:p-7">
    <div className="mx-auto max-w-6xl">
      <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="mb-2 text-[10px] font-black uppercase tracking-[0.22em] text-rose-500">Sales inbox</p>
