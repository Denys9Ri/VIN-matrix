  ...
  return (
    <div style={{ backgroundColor: '#121212', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ffffff' }}>
      <form onSubmit={handleSubmit} style={{ backgroundColor: '#1e1e1e', padding: '40px', borderRadius: '12px', display: 'flex', flexDirection: 'column', width: '350px', boxShadow: '0 4px 15px rgba(0,0,0,0.5)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: '25px' }}>Реєстрація СТО</h2>
        ...
        <label style={{ marginBottom: '5px', fontSize: '14px', color: '#aaa' }}>Назва вашого СТО</label>
        <input name="company_name" onChange={handleChange} required placeholder="Наприклад: АвтоГараж Плюс" style={{ marginBottom: '20px', padding: '12px', borderRadius: '6px', border: '1px solid #333', background: '#2c2c2c', color: '#fff' }} />
