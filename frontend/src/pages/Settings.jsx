...
const Settings = () => {
  ...
  const handleAddMechanic = async (e) => {
    ...
    try {
      ...
      alert("Помилка при додаванні майстра. Перевірте, чи не зайнятий логін.");
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col justify-between">
            ...
            <div className="space-y-3 mt-4">
              ...
              <button onClick={() => setIsChangingPassword(true)} className="w-full text-purple-600 font-bold text-sm hover:bg-purple-50 p-2 rounded-lg text-left transition-colors">Змінити пароль</button>
      ...
      {/* Модалки (Додавання майстра, Зміна пароля, Редагування профілю) залишаються без змін */}
    </div>
  );
};
